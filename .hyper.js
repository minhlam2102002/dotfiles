...
module.exports = {
  config: {
    ...
    cursorColor: 'rgba(195,55,100,0.8)',
    ...
    selectionColor: 'rgba(195,55,100,0.3)',
    // border color (window, tabs)
    borderColor: '#rgba(0, 0, 0, 0)',
    // custom CSS to embed in the main window
    css: `.header_windowHeader span{display: none;} .header_windowHeader:after { content: '-- Terminal --';}`,
